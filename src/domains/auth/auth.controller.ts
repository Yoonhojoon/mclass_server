...
export class AuthController {
  ...
  async login(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('❌ 로그인 컨트롤러 오류', { error: error instanceof Error ? error.message : 'Unknown error' });
  ...
  async register(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('❌ 회원가입 컨트롤러 오류', { error: error instanceof Error ? error.message : 'Unknown error' });
  ...
  async socialLogin(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.info('🔗 소셜 로그인 컨트롤러 호출', { provider: profile.provider, email: profile.email });
      ...
      logger.error('❌ 소셜 로그인 컨트롤러 오류', { error: error instanceof Error ? error.message : 'Unknown error' });
  ...
  async completeSignUp(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('❌ 약관 동의 완료 컨트롤러 오류', { error: error instanceof Error ? error.message : 'Unknown error' });
  ...
  async logout(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('❌ 로그아웃 컨트롤러 오류', { error: error instanceof Error ? error.message : 'Unknown error' });
  ...
  async refreshToken(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('❌ 토큰 갱신 컨트롤러 오류', { error: error instanceof Error ? error.message : 'Unknown error' });
  ...
  async changePassword(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('❌ 비밀번호 변경 컨트롤러 오류', { error: error instanceof Error ? error.message : 'Unknown error' });
